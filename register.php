    ...
    if ($username === "" || $password === "") {
        ...
        if (file_exists("users.csv")) {
            ...
            foreach ($rows as $i => $row) {
                ...
                if (isset($fields[1]) && $fields[1] === $username) {
                    $exists = true;
                    break;
                }
            }
...
<head>
    ...
    <title>Register - IncidentGuard</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .register-container .logo h1 span {
            color: #00b4d8;
        }
    ...
    <div class="register-container">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <p class="password-hint">Minimum 6 characters recommended</p>
            </div>
